...
function buildWorldMatrix(transform: SceneWorldTransform): Float32Array {
...
function getSplatOrientationMatrix(
...
export function collectScene3DLayers(
  ...
  for (const data of layerData) {
    ...
    const worldMatrix = buildWorldMatrix(worldTransform);
    const base = {
