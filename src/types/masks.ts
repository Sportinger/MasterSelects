...
export interface ClipMask {
  ...
  featherOffset?: number; // Signed contour expansion in pixels; positive moves outward.
  featherBalance?: number; // Transition midpoint balance (-100 inward to +100 outward); 0 is centered.
