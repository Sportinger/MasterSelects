...
export const embroidery = createCatalogEffect({ id: 'embroidery', name: 'Knitted Embroidery', category: 'geometry', shader, entryPoint: 'embroideryFragment', animated: true });
export const kilim = createCatalogEffect({ id: 'kilim', name: 'Kilim Carpet', category: 'geometry', shader, entryPoint: 'kilimFragment' });
export const outline = createCatalogEffect({ id: 'outline', name: 'Outline', category: 'geometry', shader, entryPoint: 'outlineFragment', animated: true });
export const bricks = createCatalogEffect({ id: 'bricks', name: '3D Toy Bricks', category: 'geometry', shader, entryPoint: 'bricksFragment', animated: true });
