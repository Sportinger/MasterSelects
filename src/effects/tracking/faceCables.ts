...
export const faceCables: EffectDefinition = {
  ...
  params: {
    ...
    lightHorizontal: { type: 'number', label: 'Light horizontal', default: -30, min: -75, max: 75, hidden: true, animatable: false },
    lightVertical: { type: 'number', label: 'Light vertical', default: -35, min: -75, max: 75, hidden: true, animatable: false },
    shadowStrength: { type: 'number', label: 'Shadow strength', default: 0.65, min: 0, max: 1, hidden: true, animatable: false },
    shadowSoftness: { type: 'number', label: 'Shadow softness', default: 0.04, min: 0, max: 0.3, hidden: true, animatable: false },
    ...
    globalWindStrength: { type: 'number', label: 'Shared wind strength', default: 5, min: 0, max: 30, hidden: true },
    globalWindYaw: { type: 'number', label: 'Shared wind direction', default: 0, min: -180, max: 180, hidden: true },
    globalWindPitch: { type: 'number', label: 'Shared wind elevation', default: 0, min: -90, max: 90, hidden: true },
    globalWindGusts: { type: 'number', label: 'Shared wind gusts', default: 0.25, min: 0, max: 1, hidden: true },
