...
export const subject = createTrackingEffect({ id: 'subject', name: 'Subject', entryPoint: 'subjectFragment', variant: 0 });
export const trackedScene = createTrackingEffect({ id: 'tracked-scene', name: 'Motion Lab', entryPoint: 'trackedSceneFragment', variant: 1, animated: true });
...
export const cctv = createTrackingEffect({ id: 'cctv', name: 'CCTV Surveillance', entryPoint: 'cctvFragment', variant: 3, animated: true });
export const kineticTrace = createTrackingEffect({ id: 'kinetic-trace', name: 'Trace Motion', entryPoint: 'kineticTraceFragment', variant: 4, animated: true, feedback: true });
