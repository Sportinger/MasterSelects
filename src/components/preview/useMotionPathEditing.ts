import { buildMotionPathPositionUpsertOperations, buildMotionPathBezierHandleOperations } from './motionPathEditOperations';
export { buildMotionPathPositionUpsertOperations, buildMotionPathBezierHandleOperations } from './motionPathEditOperations';
import {
  useCallback,
  useEffect,
  useMemo,
...
export function useMotionPathEditing({
  ...
  const sourceKeyframes = useTimelineStore(useCallback(
  ...
  const keyframes = eligibility.eligible ? sourceKeyframes : EMPTY_KEYFRAMES;
