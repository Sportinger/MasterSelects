...
export const PROCESSING_COMPOSITIONS = [
  ...
  extractImageComposition(createDefaultRadialBlurGraph(), {
    id: 'coordinates.centered-scale.vec2', label: 'Scale From Center',
  ...
  extractImageComposition(createDefaultSaturationGraph(), {
    id: 'color.luma-saturation.rgb', label: 'Luma Saturation',
  ...
  extractImageComposition(createDefaultContrastGraph(), {
    id: 'color.contrast-pivot.rgb', label: 'Contrast Around Midgray',
  ...
  extractImageComposition(createDefaultGlowGraph(), {
    id: 'color.soft-bright-pass', label: 'Soft Bright Pass',
  ...
  extractImageComposition(createDefaultEdgeDetectGraph(), {
    id: 'color.sobel-magnitude', label: 'Sobel Magnitude',
  ...
  extractImageComposition(ascii, {
    id: 'glyph.cell-grid', label: 'Glyph Cell Grid',
  ...
  extractImageComposition(ascii, {
    id: 'glyph.tone-index', label: 'Tone to Glyph Index',
  ...
  extractImageComposition(ascii, {
    id: 'glyph.atlas-alpha', label: 'Glyph Atlas Alpha',
  ...
  extractImageComposition(createDefaultAsciiGhostGraph(), {
    id: 'feedback.decay-max-rgba', label: 'Decay & Max RGBA',
