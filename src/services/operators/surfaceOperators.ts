...
export const SURFACE_OPERATORS: readonly OperatorDefinition[] = [
  op('geometry.face', 'Face Mesh', 'Converts tracked points into geometry using face topology and source-image UVs. Tracking remains a separate input.',
  ...
  op('geometry.depth', 'Depth Mesh', 'Reconstructs a UV-mapped image surface from calibrated depth. No MediaPipe dependency.',
