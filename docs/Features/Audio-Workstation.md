...
- Audio track headers use timeline-embedded mixer-strip controls with live Peak/RMS metering, fader, dB readout, pan readout, core routing buttons, responsive density classes, and compact fallbacks for short tracks.
...
- EQ, pan, filters, hum notch, de-click, noise reduction, compressor, limiter, noise gate, expander, delay, reverb, de-esser.
...
- Runtime meter aggregation for live compressor/de-esser and sample-domain limiter/noise-gate/expander gain-reduction snapshots.
...
- Registry coverage verifies pan, parametric EQ, hum notch, de-click, noise reduction, and saturation descriptors, live route projection, type guards, default-audible processed-analysis invalidation, and deterministic sample-domain rendering without constructing an unrelated offline node graph.
...
- Timeline audio track-header checks cover responsive density selection, dB/pan readout formatting, and vertical meter fill/peak-marker behavior.
