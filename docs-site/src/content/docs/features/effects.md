...
The separate [Space-time slice](/features/slit-scan-3d/#space-time-slice-observed-depth)
...
offer **Bake and use as time map** through the shared [Depth controls](/features/depth-estimation/#slit-scan-time-maps).
