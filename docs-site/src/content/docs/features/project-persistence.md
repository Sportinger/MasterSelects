...
- Composition annotations (`annotations`: timed notes, optionally linked to a clip; media files carry their own `sourceAnnotations`, see [Annotations](/features/annotations/))
...
|-----------|-------|----------|
| `serialization.test.ts` | Multiple | Serialize/deserialize, round-trip |
| `historyStore.test.ts` | Multiple | Undo/redo and project-history persistence |
