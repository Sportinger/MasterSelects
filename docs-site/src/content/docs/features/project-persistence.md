...
- [Media Panel](/features/media-panel/) - Media management
- [Timeline](/features/timeline/) - Timeline data
- [Audio](/features/audio/) - Transcript persistence
- [UI Panels](/features/ui-panels/) - Layout saving
...
|-----------|-------|----------|
| [`serialization.test.ts`](https://github.com/Sportinger/MasterSelects/blob/master/tests/unit/serialization.test.ts) | Multiple | Serialize/deserialize, round-trip |
| [`historyStore.test.ts`](https://github.com/Sportinger/MasterSelects/blob/master/tests/stores/historyStore.test.ts) | Multiple | Undo/redo and project-history persistence |
