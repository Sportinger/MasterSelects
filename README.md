...
| **Nodes** | One clip canvas with nested groups, executable texture/material/geometry nodes, detailed face/depth processing, synchronized effect controls and a searchable catalog. Keyframe nodes show live curves and share timeline animation across compatible parameters; existing project keyframes appear automatically. Typed ports show accepted formats; Video Source exposes reusable tracking and saved depth alongside audio analysis. |
