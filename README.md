...
| **Audio** | Edit waveforms and spectrograms, mix tracks with effects and sends, record audio, and separate stems. Audio effects use video-style cards with bypass, ordering grips, keyframes, and a searchable text-only effect picker. |
