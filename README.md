...
| **Nodes** | Build and reuse effect, color, geometry, and 3D graphs with typed connections and live previews. Cables fade with overlapping group depth; short forward links avoid unnecessary loops. |
