...
| **Nodes** | See all clip processing on one canvas, expand or collapse colored effect groups, edit shared parameters and keep effect order synchronized with Properties. |
